...
證照欄視為已持有的證照，仍保留不依賴該證照的可選路徑；相關類科高考／普考路徑不由學歷直接判定合格。列表的「專科以上／高職」是所選學歷情境，考試路徑本身不新增法條沒有的畢業要求。未提供證照時，HACCP分別列出一般60小時與五種具名證書30小時組合。
...
文件介面依需求統一為「申請書」，第8條原文是「申報書一份」。任職、聘僱或契約文件須滿足第8條契約書影本要求；此說明與來源放在詳細內容。
